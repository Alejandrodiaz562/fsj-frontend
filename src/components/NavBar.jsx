...
const NavBar = ({categories}) => {
    ...
    const menuOpenClasses = 'rounded-xl bg-myblue fixed  right-3 top-26 w-[200px] h-[380px] flex flex-col items-center transition-transform duration-800 ease-in-out sm:left-[-380px]'

    const menuCloseClasses = 'rounded-xl bg-myblue fixed right-3 top-26 w-[200px] h-[380px] flex flex-col items-center translate-x-[215px] transition-transform duration-400 ease-in sm:left-[-590px]'
